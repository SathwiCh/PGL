...
"}")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.energy_btn_3.setFont(font)
        self.energy_btn_3.setStyleSheet("")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.incomer_btn_3.setFont(font)
...
"}")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, -472, 972, 2000))
...
"}")
        ...
        self.gridLayout_13.addWidget(self.stackedWidget_3, 2, 0, 1, 4)
...
"}")
        ...
        self.full_menu_widget.setStyleSheet("border-radius: 10px;")
